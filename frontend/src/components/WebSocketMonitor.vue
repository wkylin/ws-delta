...
@media (max-width:1000px) { .monitor-kpis { grid-template-columns:repeat(2,1fr); }.monitor-kpis article { border-top:1px solid var(--line); }.monitor-grid { grid-template-columns:1fr; } }
@media (max-width:600px) { .monitor-view { padding:14px; }.monitor-head { align-items:flex-start; flex-direction:column; }.monitor-kpis { grid-template-columns:1fr 1fr; }.metric-table__head,.metric-table__row { grid-template-columns:20px minmax(0,1fr) 50px; }.metric-table__head span:last-child,.metric-table__row small { grid-column:1/-1; text-align:left; }.frame-list summary { grid-template-columns:58px 18px minmax(0,1fr) auto; }.frame-topic { grid-column:3; }.incident-list summary { grid-template-columns:8px 58px minmax(0,1fr); }.incident-list code { grid-column:3; }.incident-list pre,.frame-list pre { margin-left:0; } }
</style>
